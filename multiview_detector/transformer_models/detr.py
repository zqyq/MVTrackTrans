...
class DETR(nn.Module):
    ...
    def forward(self, samples: NestedTensor,prev_samples: NestedTensor,cal, pre_cts):
        ...
        features, pos = self.backbone(samples,cal)
...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        target_boxes = torch.cat([t['boxes'][0][i] for t, (_, i) in zip(targets, indices)], dim=0)
