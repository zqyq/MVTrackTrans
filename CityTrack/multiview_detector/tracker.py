...
from multiview_detector.transformer_models import backbone
...
class Tracker:
    ...
    def __init__(self, obj_detect, backnbone,reid_network, flownet, tracker_cfg, postprocessor=None, main_args=None):
