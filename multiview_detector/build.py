...
from multiview_detector.transformer_models.backbone import build_backbone
from multiview_detector.transformer_models.deformable_detr import DeformableDETR, DeformablePostProcess
from multiview_detector.transformer_models.deformable_transformer import build_deforamble_transformer
from multiview_detector.transformer_models.detr import DETR, PostProcess, SetCriterion
from multiview_detector.transformer_models.detr_segmentation import (DeformableDETRSegm, DeformableDETRSegmTracking,
                                DETRSegm, DETRSegmTracking,
                                PostProcessPanoptic, PostProcessSegm)
from multiview_detector.transformer_models.detr_tracking import DeformableDETRTracking, DETRTracking
from multiview_detector.transformer_models.matcher import build_matcher
from multiview_detector.transformer_models.transformer import build_transformer


def build_model(args,train_set):
    # num_classes = 91
    num_classes = 20
        # num_classes = 1
